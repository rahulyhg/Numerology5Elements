...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String SERVER_ADDRESS = "http://budimulyono.com/registration.php";
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                String user_email = mEmail;
                String device_id = "00";
                String link = SERVER_ADDRESS;
                String phone_no = "01020304";
                String user_password = mPassword;
...
//                User returnedUser = new User(sb.toString(),"",device_id, phone_no, kode_pos);
                reader.close();
                wr.close();
//                return true;
...
//            }
            ...
            userInfoEditor.putBoolean("login", true);
